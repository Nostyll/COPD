...
if (preg_match("/caladmin.alt.php/i", $_SERVER['PHP_SELF']))
{
...
<tr>
<td nowrap="nowrap" bgcolor="#'.$conf->calendar_title_background_color.'" height="50" align="center" width="100%" colspan="2">
...
<tr>
<td nowrap="nowrap" bgcolor="#'.$conf->calendar_title_background_color.'" width="100%" align="center" height="40" colspan="2">
...
<tr>
<td nowrap="nowrap" bgcolor="#'.$conf->calendar_title_background_color.'" width="400" valign="top">
<table bordercolor="#'.$conf->calendar_border_color.'" width="100%" cellspacing="0" cellpadding="4" border="1">
<tr>
<td nowrap="nowrap" bgcolor="#'.$conf->calendar_title_background_color.'" width="40%" height="40" align="right">
<font size="2" point-size="12" color="#'.$conf->calendar_title_text_color.'">'.$lang->word_username.':</font>
</td>
<td nowrap="nowrap" bgcolor="#'.$conf->calendar_title_background_color.'" width="60%" height="40">
...
<td nowrap="nowrap" bgcolor="#'.$conf->calendar_title_background_color.'" width="200" valign="top">
<table width="100%" cellspacing="0" cellpadding="4" border="1">
<tr>
<td nowrap="nowrap" bgcolor="#'.$conf->calendar_title_background_color.'" align="center">
...
';
			...
			for ($i = 0; $i < $numofusers; $i++)
			{
				...
				$this->pagelayout .= '<tr>
<td nowrap="nowrap" bgcolor="#'.$conf->calendar_title_background_color.'">
...
<tr>
<td nowrap="nowrap" bgcolor="#'.$conf->calendar_title_background_color.'" align="center" width="100%">
...
<tr>
<td nowrap="nowrap" bgcolor="#'.$conf->calendar_title_background_color.'" height="40p" align="center" width="100%" colspan="2">
...
<tr>
<td nowrap="nowrap" bgcolor="#'.$conf->calendar_title_background_color.'" width="450" valign="top">
<table bordercolor="#'.$conf->calendar_border_color.'" width="450" cellspacing="0" cellpadding="4" border="1">
<tr>
';
			if ($this->userid['level'] == 2)
				$this->pagelayout .= '<td nowrap="nowrap" bgcolor="#'.$conf->calendar_title_background_color.'" width="34%">
<font size="2" point-size="12" color="#'.$conf->calendar_title_text_color.'">'.$lang->word_username.': '.$this->userid['userid'].'</font>
</td>
<td nowrap="nowrap" bgcolor="#'.$conf->calendar_title_background_color.'" width="76%" align="center">
<input type="submit" name="submit" value="'.$lang->word_user_admin.'" />';
			else
				$this->pagelayout .= '<td nowrap="nowrap" bgcolor="#'.$conf->calendar_title_background_color.'" width="100%" colspan="2">
<font size="2" point-size="12" color="#'.$conf->calendar_title_text_color.'">'.$lang->word_username.': '.$this->userid['userid'].'</font>';		
			$this->pagelayout .= '
</td>
</tr>
<tr>
<td nowrap="nowrap" bgcolor="#'.$conf->calendar_title_background_color.'" width="100%" align="center" colspan="2">
<font size="2" point-size="12" color="#'.$conf->calendar_title_text_color.'"><b>'.$lang->word_events.'</b></font>
</td>
</tr>
<tr>
<td nowrap="nowrap" bgcolor="#'.$conf->calendar_title_background_color.'" width="34%" align="right">
<font size="2" point-size="12" color="#'.$conf->calendar_title_text_color.'">'.$lang->word_event_title.':</font>
</td>
<td nowrap="nowrap" bgcolor="#'.$conf->calendar_title_background_color.'" width="76%">
<input type="text" name="eventtitle" maxlength="50" size="38" />
</td>
</tr>
<tr>
<td nowrap="nowrap" bgcolor="#'.$conf->calendar_title_background_color.'" width="34%" align="right" valign="top" height="60">
<font size="2" point-size="12" color="#'.$conf->calendar_title_text_color.'">'.$lang->word_event_details.':</font>
</td>
<td nowrap="nowrap" bgcolor="#'.$conf->calendar_title_background_color.'" width="76%" height="60">
						...
						for ($k = 0; $k < 4; $k++)
						{
							...
							if (isset($_POST['starttime']))
							{
								if ($_POST['starttime'] == sprintf('%02d:%02d:00', $twentyfour, $onmin))
									$this->pagelayout .= ' selected="selected"';
							}
							else
							{
...
<td nowrap="nowrap" bgcolor="#'.$conf->calendar_title_background_color.'" width="300" valign="top">
<table bordercolor="#'.$conf->calendar_border_color.'" width="300" cellspacing="0" cellpadding="2" border="1">
<tr>
<td nowrap="nowrap" bgcolor="#'.$conf->calendar_title_background_color.'" width="100%" valign="middle" align="center" colspan="2">
...
';
				...
				for ($i = 0; $i < $datecount; $i++)
				{
					...
					$this->pagelayout .= '<tr>
<td nowrap="nowrap" bgcolor="#'.$conf->calendar_title_background_color.'" width="100%">
