...
if (preg_match("/caladmin.inc.php/i", $_SERVER['PHP_SELF']))
{
...
<script type="text/javascript" src="adminjavascript.js.php"></script>
';
				$this->closeheader();
			}
			else
...
'.$lang->word_day.': 
<input type="text" name="dateday" style="width: 25px; height: 14px" maxlength="2" '.$datedis.'/>
'.$lang->word_year.': 
