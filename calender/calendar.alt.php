...
<tr>
<td nowrap="nowrap" align="left" valign="middle" bgcolor="#'.$conf->html_body_background_color.'" width="250">
...
<td nowrap="nowrap" align="right" valign="middle" bgcolor="#'.$conf->html_body_background_color.'" width="450">
...
<tr>
<td nowrap="nowrap" width="200" height="24" bgcolor="#'.$conf->calendar_title_background_color.'" valign="middle" align="left">
&nbsp;';
...
<td nowrap="nowrap" width="300" height="24" bgcolor="#'.$conf->calendar_title_background_color.'" valign="middle" align="center">
<font size="3" point-size="16" color="#'.$conf->calendar_title_text_color.'"><b>'.$lang->month_long[$current_month].' '.$current_year.'</b></font>
</td>
<td nowrap="nowrap" width="200" height="24" bgcolor="#'.$conf->calendar_title_background_color.'" valign="middle" align="right">
';
...
<a href="http://www.iamwhen.com" target="_blank"><font size="1" point-size="10" color="#'.$conf->html_body_text_color.'">Web Calendar &copy;2009 Proverbs, LLC. All rights reserved.</font></a>
</center>';
