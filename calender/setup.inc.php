...
if (preg_match("/setup.inc.php/i", $_SERVER['PHP_SELF']))
{
...
if(!defined("LAYOUT_SETUP")) 
{
	...
	class layout_setup
	{
		...
		var $calendar_title_text = 'Afspraken agenda';
		...
		// Available options: 'dutch', 'english', 'french', 'german', 'hebrew', 'italian', 'norsk', 'polish', 'portuguese', 'spanish'
		var $display_language = 'dutch';
