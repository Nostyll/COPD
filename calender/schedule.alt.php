...
if (preg_match("/schedule.alt.php/i", $_SERVER['PHP_SELF']))
{
...
<tr>
<td nowrap="nowrap" width="100%" align="right" valign="middle" bgcolor="#'.$conf->schedule_time_background_color.'" height="40" colspan="4">
<center>
...
<td nowrap="nowrap" width="10%" height="50" align="right" valign="middle" bgcolor="#'.$conf->schedule_time_background_color.'">
