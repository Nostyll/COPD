...
{ 
	...
	class calendar_page extends base_calendar
	{
		...
		function createpage($current_day, $current_month, $current_year)
		{
			...
			if ($this->makeheader() !== false)
			{
				$this->pagelayout .= '<link rel="stylesheet" type="text/css" href="stylesheet.css.php" />
...
<tr>
<td nowrap="nowrap" class="calmenu" style="width: 250px">
...
';
		   ...
		   for ($i = 0; $i < 7; $i++)
		   {
	         ...
	         $this->pagelayout .= '<td class="calweekday" nowrap="nowrap">
<b>'.$lang->day_long[$n].'</b>
</td>
';
		      $n++;
...
';
		...
		function addcalday($curday, $istoday, $textdisplay)
		{
			...
			if ($istoday)
				$this->pagelayout .= '<td nowrap="nowrap" class="calday" style="background-color: #'.$tempconf->calendar_today_background_color.'" onmouseover="tdmv(this)" onmouseout="tdtmo(this)" onclick="sendDay('.$curday.', '.$this->activemonth.', '.$this->activeyear.')">
'.$curday.'<br />
';
			else	
				$this->pagelayout .= '<td nowrap="nowrap" class="calday" onmouseover="tdmv(this)" onmouseout="tdmu(this)" onclick="sendDay('.$curday.', '.$this->activemonth.', '.$this->activeyear.')">
'.$curday.'<br />
';
