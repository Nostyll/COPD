...
div.event {overflow: hidden; position: relative; border-style: solid; border-width: 1px; border-color: #'.$conf->event_border_color.'; 
	background-color: #'.$conf->event_background_color.'; color: $'.$conf->event_text_color.'; font-size: 11px; 
	text-align: left; padding: 3px; padding-top: 0px; padding-bottom: 0px; cursor: hand}
...
td.aminical {width: 22px; height: 18px; max-height: 18px; min-height: 18px; max-width: 22px; min-width: 22px; 
	...
	vertical-align: middle; text-align: right; cursor: hand}
td.event {text-indent: 0px; font-size: 12px; padding: 4px; width: 100%; height: 240px; color: #'.$conf->event_text_color.';
